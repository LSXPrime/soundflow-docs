...
3. **Replace the contents of `Program.cs` with the following code:**
    ...
    internal static class Program
    {
        private static void Main(string[] args)
        {
            ...
            string filePath = Path.Combine(Directory.GetCurrentDirectory(), "output.wav");
            using var recorder = new Recorder(filePath, sampleRate: 48000, encodingFormat: EncodingFormat.Wav);
            ...
            Console.WriteLine($"Recording stopped. Saved to {filePath}");
        }
    }
    ```
