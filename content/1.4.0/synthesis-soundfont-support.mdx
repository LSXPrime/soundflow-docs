...
SoundFlow includes robust support for the industry-standard **SoundFont 2 (.sf2)** file format. This allows you to load vast libraries of high-quality, multi-sampled instruments and use them directly within the `Synthesizer` component. This feature is enabled by the `SoundFontBank` class.
